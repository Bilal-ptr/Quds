...
const TeamMemcard = ({name, position, profileLink,description, linkedin, twitter, github, image}) => {
  return (
<>
    ...
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className="social-icons p-2 ">
            <a href={linkedin} target="_blank" rel="noopener noreferrer" className=' m-2 pb-4'>
            <i className="bi bi-facebook fac" aria-hidden="true"></i>
            </a>
            <a href={twitter} target="_blank" rel="noopener noreferrer" className=' m-2 pb-4'>
            <i className="bi bi-linkedin lin " aria-hidden="true"></i>
            </a>
            <a href={github} target="_blank" rel="noopener noreferrer" className='m-2 pb-4'>
